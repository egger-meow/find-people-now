...
class HelpScreen extends StatelessWidget {
  ...
  static const _steps = [
    ...
    (
      ...
      '4. 配對成功',
      '成團後可以在「我的活動」找到這個活動，進去後有「地點與集合」跟「成員與聯絡」兩個分頁：「地點與集合」分頁大家一起投票決定活動地點（投票結果即時顯示目前領先候選，且隨時能改票）並設定集合地點；「成員與聯絡」分頁填寫給隊友看的見面提示、查看隊友資料與聯絡方式，也能在這裡封鎖或檢舉。',
    ),
    (
      Icons.near_me_rounded,
      '5. 到了現場',
      '抵達集合地點後，到「成員與聯絡」分頁點自己卡片上的「我到了」，其他隊友會立刻收到通知；同組成員也能在這裡看到誰已經到了，方便判斷要不要先開始。這個動作送出後無法收回，按之前系統會再跟你確認一次。',
    ),
    (
