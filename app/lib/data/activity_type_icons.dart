...
IconData activityTypeIcon(String name) {
  ...
  const table = <String, IconData>{
    ...
    '唱k': Icons.mic_rounded,
    '唱': Icons.mic_rounded,
    'ktv': Icons.mic_rounded,
    '練舞': Icons.music_note_rounded,
    '跳舞': Icons.music_note_rounded,
    '街舞': Icons.music_note_rounded,
    '熱舞': Icons.music_note_rounded,
    '舞': Icons.music_note_rounded,
