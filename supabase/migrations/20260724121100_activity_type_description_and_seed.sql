-- =============================================================================
-- activity_type.description + 官方預設類型「先聚聚看」
-- 派生自使用者需求（v1.10）
-- =============================================================================
